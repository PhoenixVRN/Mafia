...
public class Promise {
    ...
    public Object resolve(Object object) {
        if (!isResolved) {
            ...
            if (onSuccessListener != null) {
                ...
                if (handler != null) {
                    handler.post(() -> handleDone(child, resolvedObject));
                } else {
                    new Thread(() -> handleDone(child, resolvedObject)).start();
                }
            }
        } else {
    ...
    public Promise then(OnDoneListener listener) {
    ...
    private void handleDone(Promise child, Object object) {
        if (onDoneListener != null) {
            onDoneListener.onSuccess(object);
            if (child != null) {
